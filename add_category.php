...
require_once("thumbnail_images.class.php");
	...
	if(isset($_POST['submit']) and isset($_GET['add']))
	{
     ...
     $tpath1='imagess/menuImages/'.$category_image;        
...
if(isset($_POST['submit']) and isset($_POST['cat_id']))
{
 ...
 {    
    ...
    //  {
      ...
      //          unlink('imagess/menuImages/'.$img_res_row['category_image']);
//
      //     }
											...
											<div class="media-left">
												<div class="media-body">
												   ...
												   <?php if(isset($_GET['cat_id']) and $row['category_image']!="") {?>
													<img src="imagess/menuImages/<?php echo $row['category_image'];?>" style="width: 75px; height: 75px;" class="img-rounded" alt="">
													<?php } else{?>
