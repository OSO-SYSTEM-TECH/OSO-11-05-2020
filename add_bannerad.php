...
if(isset($_POST['submit']) and isset($_GET['add']))
{
     ...
     $banner_image=rand(0,99999)."_".$_FILES['banner_image']['name'];
       ...
       //Main Image
		$tpath1='imagess/bannerImages/'.$banner_image;        
    ...
    echo '<script type="text/javascript">
           ...
           window.location = "manage_bannerad.php"
     ...
     {    
        ...
        $img_res=mysqli_query($mysqli,'SELECT * FROM tbl_banner_ad WHERE id='.$_GET['cat_id'].'');
          ...
          if($img_res_row['banner_image']!="")
            {
                unlink('imagess/bannerImages/'.$img_res_row['banner_image']);
           }
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" action="" name="addeditcategory" method="post" enctype="multipart/form-data">
							...
							<fieldset class="content-group">
								<legend class="text-bold">Banner Info</legend>

								<div class="form-group">
									<label class="control-label col-lg-2">Banner Title :-</label>
									<div class="col-lg-10">
											...
											<div class="media-left">
												<div class="media-body">
												   ...
												   <?php if(isset($_GET['cat_id']) and $row['banner_image']!="") {?>
													<img src="imagess/bannerImages/<?php echo $row['banner_image'];?>" style="width: 75px; height: 75px;" class="img-rounded" alt="">
													<?php } else{?>
													<img src="assets/images/placeholder.jpg" style="width: 75px; height: 75px;" class="img-rounded" alt=""/>                                   
													<?php }?>
													<span class="help-block">Accepted formats: gif, png, jpg. Max file size 2Mb <a href=https://www.iloveimg.com/crop-image target="_blank">crop my image</a></span>
												</div>
											</div>
										</div>
									</div>
