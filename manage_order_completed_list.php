...
$result=mysqli_query($mysqli,$data_qry);
...

    {
           ...
           window.location = "manage_order_completed_list.php"
...
<div class="page-header">
	...
	<div class="page-header-content">
		...
		<div class="page-title">
			...
			<h4><span class="text-semibold">Completed Orders</span></h4>
					...
					<table class="table table-bordered datatable-highlight">
						...
						<?php 
							...
							<tr>
							    ...
							    <?php if (get_order_status($row['order_unique_id'])=="Completed")
							    
							    {
							    
							    ?>

								<td><a href="manage_order_list_completed_view.php?order_unique_id=<?php echo $row['order_unique_id'];?>" title="View Order"><?php echo $row['order_unique_id'];?></a></td>
                                ...
                                <td>
                                    ...
                                    <?php if (get_order_status($row['order_unique_id'])=="Completed") {
                                                ?>
                                                <button type="button" class="btn"><a href="manage_order_completed_list.php?status_pending_id=<?php echo $row['order_unique_id'];?>&status_value=Made">Not Completed</a></li></button>
                                                <?php
                                            }
                                            else if (get_order_status($row['order_unique_id']) == "Not Completed") {
                                            ?>
                                                <button type="button" class="btn"><a href="manage_order_completed_list.php?status_pending_id=<?php echo $row['order_unique_id'];?>&status_value=Pending">Completed</a></li></button>
                                            <?php 
                                            }
                                            ?>
                                    </div>
								...
								<td class="text-center">
									...
									<ul class="icons-list">
                                                ...
                                                <li><a href="manage_order_completed_list_view.php?order_unique_id=<?php echo $row['order_unique_id'];?>"> <i class="icon-eye2"></i></a></li>
