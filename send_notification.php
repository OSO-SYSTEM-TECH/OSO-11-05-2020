					...
					<div class="panel-body">
						...
						<form class="form-horizontal" action="" name="addeditcategory" method="post" enctype="multipart/form-data">
							...
							<fieldset class="content-group">
								<legend class="text-bold">Notification Information</legend>
								...
								<div class="form-group">
								  ...
								  <div class="form-group">
									<label class="control-label col-lg-2">Image :-<br/>(Optional)<p class="control-label-help">Resultion: 600x293  650x317  700x342  750x366</p><a href=https://www.iloveimg.com/crop-image target="_blank">Crop My Image</a></label>
							...
							<div class="text-right">
								<button type="submit" name="submit" class="btn btn-primary">Send<i class="icon-arrow-right14 position-right"></i></button>
							</div>
						</form>
					</div>
				</div>
