...
if(isset($_GET['cat_id']))
{
...

	{
	   ...
	   unlink('imagess/menuImages/'.$cat_res_row['category_image']);
		...
		echo '<script type="text/javascript">window.location = "manage_category.php"</script>';
					...
					<table class="table table-bordered table-hover datatable-highlight">
						...
						<?php 
							...
							<tr>
								...
								<td><img src="imagess/menuImages/<?php echo $row['category_image'];?>" width="150" height="100" /></td>
