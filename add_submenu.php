    ...
    {     
    	...
    	{    
    	  ...
    	  if($img_res_row['menu_image']!="")
    		{
    			unlink('imagess/menuImages/'.$img_res_row['menu_image']);
    		}
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" action="" name="addeditcategory" method="post" enctype="multipart/form-data">
							...
							<fieldset class="content-group">
								<legend class="text-bold">Add Dish</legend>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="number" placeholder="1.00" step="0.01" min="0.01" class="form-control m-input" name="menu_price" id="menu_price" value="<?php if(isset($_GET['menu_id'])){echo $row['menu_price'];}?>" placeholder="Enter Price" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-lg-2">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" placeholder="1" class="form-control m-input" name="menu_weight" id="menu_weight" value="<?php if(isset($_GET['menu_id'])){echo $row['menu_weight'];}?>" placeholder="Enter Weight" required>
                                </div>
                            </div>
											...
											<div class="media-left">
												<div class="media-body">
												   ...
												   <?php if(isset($_GET['menu_id']) and $row['menu_image']!="") {?>
													<img src="imagess/menuImages/<?php echo $row['menu_image'];?>" style="width: 75px; height: 75px;" class="img-rounded" alt="">
													<?php } else{?>
													<img src="imagess/extra/Image-Coming-Soon.png" style="width: 85px; height: 85px;" class="img-rounded" alt=""/>                                   
													<?php }?>
								...
								<div class="form-group">
                                <label class="control-label col-lg-2">Multiple Image(s):</label>
                                <div class="col-lg-10">
                                    <div class="media no-margin-top">
                                        <div class="media-left">
                                            <div class="media-body">
                                        ...
                                        <div class="media-left">
                                            <div class="media-body">
                                                <?php
                                                    ...
                                                    { ?>
                                                <img src="imagess/menuImages/<?php echo $row['menu_image_cat']; ?>" style="width: 85px; height: 85px;" class="dish image">
                                                <a href="?prod_image=<?php echo $row['id'];?>" onclick="return confirm('Are you sure you want to remove this image?')">
