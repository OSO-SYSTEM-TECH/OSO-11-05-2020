...
<div class="page-header">
	<div class="page-header-content">
		<div class="page-title">
			<h4><span class="text-semibold">Banners</span></h4>
		</div>
		
		<div class="heading-elements">
			<div class="heading-btn-group">
				<a href="add_bannerad.php?add=yes" class="btn btn-link btn-float has-text"><i class=" icon-plus3 text-primary"></i></a>				
			</div>
		</div>
	</div>
</div>
					...
					<table class="table table-bordered table-hover datatable-highlight">
						...
						<?php 
							...
							<tr>
								...
								<td><img src="imagess/bannerImages/<?php echo $row['banner_image'];?>" width="150" height="150" /></td>
