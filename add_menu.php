  ...
  {     
        ...
        {    
          ...
          if($img_res_row['menu_image']!="")
            ...
            {
                $menu_image='imagess/menuImages/defaultImages/defaultMenuImage.png';
            }
             ...
             //Main Image
           $tpath1='imagess/menu_image'.$menu_image;        
            $pic1=compress_image($_FILES["menu_image"]["tmp_name"], $tpath1, 80);
    ...
    $_SESSION['msg']="11"; 
    header( "Location:add_menu.php?menu_id=".$_POST['menu_id'].);
    exit;
                    ...
                    <div class="m-card-profile">
                      ...
                      <div class="m-card-profile__pic">
                        <div class="m-card-profile__pic-wrapper">
                          <img src="imagess/menu_images<?php echo $rest_row['restaurant_image'];?>" alt=""/>
                        </div>
                      </div>
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12">
                                <input type="file" id="menu_image" name="menu_image" class="form-control m-input">
                                  ...
                                  <?php if(isset($_GET['menu_id']) and $row['menu_image']!="") {?>
                                    <img type="image" src="imagess/menu_images<?php echo $row['menu_image'];?>" width="150" height="100" alt="image" />                                   
                                  <?php }?>
