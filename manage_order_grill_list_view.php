                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="colcol-md-3 m--align-right">
                            <a href="?order_id=<?php echo $row['order_id'];?>" title="Delete" onclick="return confirm('Are you sure you want to delete this category?');"><i class="glyphicon glyphicon-trash"></i> </a>
                            <a href="manage_order_grill_list.php" class="btn btn-primary">
                            <span>
