...
$result=mysqli_query($mysqli,$data_qry);
...

    {
       ...
       $edit_status=Update('tbl_order_details', $data, "WHERE order_id = '".$_GET['status_pending_id']."'");
       $_SESSION['msg']="14";

	  echo '<script type="text/javascript">
           window.location = "manage_order_assembly_list.php"
...
<div class="page-header">
	...
	<div class="page-header-content">
		...
		<div class="page-title">
			...
			<h4><span class="text-semibold">Orders - Assembly</span></h4>
...
`                   <button onclick="history.go(-1);">Back </button>
				...
				<div class="panel panel-flat">
					...
					<div class="panel-heading">
						...
						<h5 class="panel-title">Orders - Assembly</h5>
					...
					<table class="table table-bordered table-hover datatable-highlight">
						...
						<?php 
	                        ...
	                        <tr>
	                            <?php
							        if (get_order_status($row['order_id'])=="Made")
							            {
							    ?>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" x-placement="top-start">
                                            <li><a class="dropdown" href="manage_order_assembly_list.php?status_pending_id=<?php echo $row['order_id'];?>&status_value=Made">Made</a></li>
                                            <li><a class="dropdown" href="manage_order_assembly_list.php?status_pending_id=<?php echo $row['order_id'];?>&status_value=Ready For Pickup">Ready For Pickup</a></li>
                                        </div>
								...
								<td class="text-center">
									...
									<ul class="icons-list">
                                                ...
                                                <li><a href="manage_order_assembly_list_view.php?order_id=<?php echo $row['order_id'];?>"> <i class="icon-eye2"></i></a></li>
